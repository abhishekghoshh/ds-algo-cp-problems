...
- **codes**
  ...
  - [Delete Last Node of Linked List](/src/com/problems/linkedlist/DeleteLastNodeInALinkedList.java)
  - [Find the Length of a Linked List](/src/com/problems/linkedlist/FindTheLengthOfLinkedList.java)
  - [Search an element in a Linked List](/src/com/problems/linkedlist/SearchElementInLinkedList.java)
  - [Introduction To Doubly Linked List](/src/com/problems/linkedlist/IntroductionToDoublyLinkedList.java)
  - [Insert at end of Doubly Linked List](/src/com/problems/linkedlist/InsertAtEndOfDoublyLinkedList.java)
  - [Delete Last Node of a Doubly Linked List](/src/com/problems/linkedlist/DeleteLastNodeOfDoublyLinkedList.java)
  ...
  - [Check if Linked List is palindrome or not](/src/com/problems/linkedlist/IsPalindromeOrNot.java)
  - [Segregate odd and even nodes in Linked List](/src/com/problems/linkedlist/SegregateOddAndEvenNodesInLinkedList.java)
  ...
  - [Sort Linked List](/src/com/problems/linkedlist/SortLinkedList.java)
  - [Sort linked list of 0s 1s 2s](/src/com/problems/linkedlist/SortLinkedListOfZeroOneTwo.java)
  - [Intersection of Two Linked Lists](/src/com/problems/linkedlist/IntersectionOfTwoLinkedList.java)
  - [Intersection of Two Linked Lists II](/src/com/problems/linkedlist/IntersectionOfTwoLinkedList2.java)
  - [Add 1 to a number represented by Linked List](/src/com/problems/linkedlist/AddOneToNumberRepresentedByLinkedList.java)
  - [Add 2 numbers in Linked List](/src/com/problems/linkedlist/AddTwoNumbers.java)
  - [Delete all occurrences of a given key in a doubly linked list](/src/com/problems/linkedlist/DeleteAllOccurrencesOfGivenKeyInDoublyLinkedList.java)
  - [Find pairs with given sum in sorted doubly linked list](/src/com/problems/linkedlist/FindPairsWithGivenSumInSortedDoublyLinkedList.java)
  - [Remove duplicates from a sorted Doubly Linked List](/src/com/problems/linkedlist/RemoveDuplicatesFromSortedDoublyLinkedList.java)
  - [Remove Duplicates from Sorted List II](/src/com/problems/linkedlist/RemoveDuplicatesFromSortedDoublyLinkedList2.java)
  - [Reverse Linked List in group of given size K](/src/com/problems/linkedlist/ReverseLinkedlistInGroupsOfSizeK.java)
...
- **codes**
  ...
  - [More subsequence](/src/com/problems/recursion/MoreSubsequence.java)
    - dynamic-programming
...
- **codes**
  ...
  - [Number of Greater Elements to the right](/src/com/problems/stack/NumberOfGreaterElementsToTheRight.java)
...
- **codes**
  ...
  - [Implement Deque using Linkedlist](/src/com/problems/queue/DequeUsingLinkedlist.java)
  - [Sliding Window maximum](/src/com/problems/queue/SlidingWindowMaximum.java)
...
- **codes**
  ...
  - [Merge k Sorted Lists](/src/com/problems/heap/MergeKSortedLists.java)
  - [Replace elements by its rank in the array](/src/com/problems/heap/ReplaceElementsByItsRankInArray.java)
  - [Task Scheduler](/src/com/problems/heap/TaskScheduler.java)
  - [Hands of Straights](/src/com/problems/heap/HandsOfStraights.java)
  - [Design Twitter](/src/com/problems/heap/DesignTwitter.java)
  - [Connect n ropes with minimum cost](/src/com/problems/heap/ConnectNRopesToMinimizeCost.java)
  - [Kth Largest Element in a Stream](/src/com/problems/heap/KthLargestElementInStream.java)
  - [Maximum Sum Combination](/src/com/problems/heap/MaximumSumCombination.java)
  - [Find Median from Data Stream](/src/com/problems/heap/FindMedianFromDataStream.java)
  - [K most frequent elements](/src/com/problems/heap/KMostFrequentElements.java)
...
- **codes**
  ...
  - [Kth prime number](/src/com/problems/prime/KthPrimeNumber.java)
...
- **codes**
  ...
  - [Meeting Rooms](/src/com/problems/greedy/MeetingRooms1.java)
  - [Meeting Rooms II](/src/com/problems/greedy/MeetingRooms2.java)
  ...
  - [candy](/src/com/problems/greedy/Candy.java)
...
- **codes**
  - **introduction**
    ...
    - [Decode Ways](/src/com/problems/dp/DecodeWays.java)
...
- **codes**
  ...
  - [Lowest Common Ancestor of a Binary Search Tree](/src/com/problems/binarysearchtree/LowestCommonAncestorInBinarySearchTree.java)
  - [Construct Binary Search Tree from Preorder Traversal](/src/com/problems/binarysearchtree/ConstructBinarySearchTreeFromPreorderTraversal.java)
  - [Inorder Successor/Predecessor in Binary Search Tree](/src/com/problems/binarysearchtree/InorderSuccessorPredecessorInBST.java)
  - [Convert a normal Binary Search Tree to Balanced Binary Search Tree](/src/com/problems/binarysearchtree/ConvertNormalBinarySearchTreeToBalanced.java)
  - [Merge Two Binary Search Tree](/src/com/problems/binarysearchtree/MergeTwoBinarySearchTree.java)
  - [Binary Search Tree Iterator](/src/com/problems/binarysearchtree/BinarySearchTreeIterator.java)
