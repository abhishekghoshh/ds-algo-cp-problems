...
public class BinarySearchTree<T extends Comparable<T>> {
    ...
    // Internal node containing node reference and the actual node data
    private class Node {
        T data;
        Node left, right;
    ...
    private Node add(Node node, T elem) {
        ...
        if (node == null) node = new Node(null, null, elem);
            ...
            // Pick a subtree to the insert element
    ...
    private Node remove(Node node, T elem) {
        ...
        if (cmp < 0) {
            ...
            // Dig into the right subtree, the value we're looking for is greater than the current value
