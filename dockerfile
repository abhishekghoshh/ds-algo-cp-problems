...
RUN mkdir -p /home/abhishek/workspace/ds-algo-cp-problems

# Set the working directory to workspace
WORKDIR /home/abhishek/workspace/ds-algo-cp-problems
...
# Copy the contents of the current directory to /home/abhishek/workspace/ds-algo-cp-problems
COPY . .
