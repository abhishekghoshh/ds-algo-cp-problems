...
**Topic:** `array` | **File:** `com/problems/array/NumberOfStudentsUnableToEatLunch.java`
...
Optimized approach todo try to come up with this in interview directly we will count student count for 0th and 1th sandwiches after counting we will go to the sandwiches array and try to give the sandwiches to each student we will iterate till, there is 0th sandwich at top and and there no student0 or if 1th sandwich at the top and there is no 1th student
