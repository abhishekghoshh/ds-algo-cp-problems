...
do not try to explain it to the interview shift k times copy the last item first shift right all the elements by one step assign the last to zeroth items
...
create one extra array copy elements to that array again copy to that original array
