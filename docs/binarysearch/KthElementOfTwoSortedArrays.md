...
- [📄 Coding Ninjas](https://www.naukri.com/code360/problems/k-th-element-of-2-sorted-array_1164159)
- [📄 Coding Ninjas](https://www.naukri.com/code360/problems/1112629)
- [📄 GeeksforGeeks](https://www.geeksforgeeks.org/problems/k-th-element-of-two-sorted-array1317/1)

## 🎥 Solution Links

- [▶ YouTube](https://www.youtube.com/watch?v=D1oDwWCq50g)
- [▶ YouTube](https://www.youtube.com/watch?v=nv7F4PiLUzo&list=PLgUwDviBIf0p4ozDR_kJJkONnb1wdx2Ma&index=67)
- [📄 takeUforward](https://takeuforward.org/data-structure/k-th-element-of-two-sorted-arrays/)
- [📄 GeeksforGeeks](https://www.geeksforgeeks.org/k-th-element-two-sorted-arrays/)
...
same as previous just this code is much cleaner best solution using binary search approach
...
binary search approach we can also use the heap approach but as the arrays are in sorted order so we can leverage this thing we always assume that n1 will be less than equal to n2 here also we will try to implement the cut logic just like the find median at min we may not take any element from 1st array and at max we can take all the elements from 1st array if k is greater than n2 then we have to take some elements from the 1st array so that time low will not be start from 0, rather we have to pick atleast k-n2 element the 1st array if k less than first array then we dont required n1 elements rather k element will be needed at worst situation, so the high will be k not n1 at that time
