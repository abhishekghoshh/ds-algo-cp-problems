...
**Topic:** `binarysearchtree` | **File:** `com/problems/binarysearchtree/FloorInBinarySearchTree.java`
...
For a valid BST the floor of a value will be the inorder predecessor of the element. as the in order traversal will give us the sorted list, we can just traverse on that list, or we can also do a binary search on that to get the flooring element
