...
**Topic:** `binarytree` | **File:** `com/problems/binarytree/DiameterOfBinaryTree.java`
...
Simple problem with simple intuition we will compute height and side by we will compute the diameter, but we need to store the diameter individually we could either use a class level variable or send another object as a parameter in the method
