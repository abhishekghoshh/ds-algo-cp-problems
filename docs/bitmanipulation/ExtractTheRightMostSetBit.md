...
**Topic:** `bitmanipulation` | **File:** `com/problems/bitmanipulation/ExtractTheRightMostSetBit.java`
...
Brute force approach time complexity O(log(n)) suppose n = 101100 so our ans will be 000100 so we can create a mask and perform and operation until it's value become other than 0
