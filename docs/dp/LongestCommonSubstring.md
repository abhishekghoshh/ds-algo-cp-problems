...
**Topic:** `dp` | **File:** `com/problems/dp/LongestCommonSubstring.java`
...
This will also print the longest common substring tabulation with space optimization, we will only create 2 arrays for storing current and prev row
...
Tabulation or top-down approach this problem is almost similar to the longest common subsequence problem, but when the characters don't match at that time, we have to directly set the value to 0
