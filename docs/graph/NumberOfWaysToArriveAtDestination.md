...
**Topic:** `graph` | **File:** `com/problems/graph/NumberOfWaysToArriveAtDestination.java`
...
Using Dijkstra algorithm but here along with a distance array we will also create another array for storing the ways
