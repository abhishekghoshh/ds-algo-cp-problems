...
**Topic:** `linkedlist` | **File:** `com/problems/linkedlist/ReverseADoublyLinkedList.java`
...
Little optimize from the previous This will use a stack to store all the datas in a reverse manner then we will pop from the stack
...
Brute force approach storing all the nodes to an array
