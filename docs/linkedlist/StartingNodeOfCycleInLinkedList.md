...
same as previous here we will no cycle is present early break to reduce extra computation we have found the collision again we will traverse from start, and the slow pointer will also go as it is, and we know that after x distance start and the slow pointer will collide
