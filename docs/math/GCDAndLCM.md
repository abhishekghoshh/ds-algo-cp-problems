...
optimized approach Continue loop as long as both a and b are greater than 0 If 'a' is greater than b, subtract b from a and update a Update 'a' to the remainder of a divided by b If b is greater than or equal to 'a', subtract a from b and update b Update b to the remainder of b divided by a
