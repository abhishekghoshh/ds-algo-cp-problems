...
**Topic:** `recursion` | **File:** `com/problems/recursion/SortStack.java`
...
It will sort the stack in the reverse sorted manner that means the bigger element will be at the top and the smaller element will be at the bottom
