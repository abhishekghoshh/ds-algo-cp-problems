...
**Topic:** `slidingwindow` | **File:** `com/problems/slidingwindow/SubarrayWithAtMostKDifferentIntegers.java`
...
Brute force time complexity O(n^2) for every i we are computing how many subarrays can be possible with at most k integers, and we are storing it counts array.
