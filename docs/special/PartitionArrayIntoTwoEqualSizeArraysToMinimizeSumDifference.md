# PartitionArrayIntoTwoEqualSizeArraysToMinimizeSumDifference

**Topic:** `special` | **File:** `com/problems/special/meetinthemiddle/PartitionArrayIntoTwoEqualSizeArraysToMinimizeSumDifference.java`
