...
**Topic:** `stack` | **File:** `com/problems/stack/InfixToPostfix.java`
...
Check it one more time same as previous, but here we will use an array as stack TODO do not use array if asked in interview
...
We will push all the operands into stack in increasing precedence if there is any lower or same precedence then we will pop
