...
**Topic:** `stack` | **File:** `com/problems/stack/SumOfSubarrayMaximum.java`
...
Same as type2 here we will use an array as stack
...
Optimized approach using the stack same as the sum of subarray minimum
